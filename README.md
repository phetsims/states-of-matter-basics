...
(5) Open in the browser: `http://localhost/states-of-matter-basics/states-of-matter-basics_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/states-of-matter-basics/build/adapted-from-phet/states-of-matter-basics_en_adapted-from-phet.html` (You will
